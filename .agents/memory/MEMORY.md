...
- [Game Start Race Guard](game-start-race-guard.md) — STARTING phase is claimed before awaits; Game.add_player only mutates the roster in LOBBY; role assignment validates fixed roster and non-None roles.
